...
const SECTIONS: NavSection[] = [
  ...
  { id: 'ui-select', label: 'Select', group: 'UI Primitives' },
  { id: 'ui-switch', label: 'Switch', group: 'UI Primitives' },
  { id: 'ui-slider', label: 'Slider', group: 'UI Primitives' },
  { id: 'ui-label', label: 'Label', group: 'UI Primitives' },
  { id: 'ui-card', label: 'Card', group: 'UI Primitives' },
  { id: 'ui-separator', label: 'Separator', group: 'UI Primitives' },
  { id: 'ui-tabs', label: 'Tabs', group: 'UI Primitives' },
  { id: 'ui-accordion', label: 'Accordion', group: 'UI Primitives' },
  { id: 'ui-table', label: 'Table', group: 'UI Primitives' },
  { id: 'ui-dialog', label: 'Dialog', group: 'UI Primitives' },
