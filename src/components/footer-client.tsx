...
export function FooterClient({
  ...
  return (
    <footer className='w-full bg-fcu-primary-900 rounded-t-4xl'>
      <motion.div
                ...
                {footerData.newsletterCta && (
                  <div>
                    {footerData.newsletterCta.heading && (
                      <h3 className='mb-4 text-lg font-semibold tracking-tight text-fcu-secondary-500 sm:text-xl'>
                        {footerData.newsletterCta.heading}
                      </h3>
                    )}
                    ...
                    <div className='mb-4 flex'>
                      <input
                        ...
                        className='flex-1 rounded-l-full border border-r-0 border-white/20 bg-white/5 px-5 py-3 text-sm text-white placeholder-white/40 focus:border-white/40 focus:outline-none'
                      />
                      <button
                        type='button'
              ...
              <div className='py-8 lg:py-10 lg:pl-10'>
                <div className='grid grid-cols-2 gap-8 sm:grid-cols-3 lg:grid-cols-4'>
                  {footerData.columns?.map((column) => (
                    <div key={column._key}>
                      <h4 className='mb-4 text-sm font-semibold tracking-tight text-fcu-secondary-500'>
                        {column.title}
                      </h4>
