        ...
        <div className='border-b border-neutral-200 pb-2 dark:border-neutral-700'>
          <div className='mb-10 max-w-xl'>
            ...
            <p className='mb-4 text-sm text-neutral-600 dark:text-neutral-400'>
              ...
              templates and Component Blocks. Built by the founders of
              Aceternity UI.
            </p>
...
const TEMPLATES = [
  {
    ...
    href: '/templates/startup-landing-page-template',
  },
...
const COMPONENT_PACKS = [
  ...
  { title: 'Logo Clouds', href: '/blocks/logo-clouds' },
  { title: 'Bento Grids', href: '/blocks/bento-grids' },
  { title: 'CTA Sections', href: '/blocks/cta-sections' },
  { title: 'Testimonials', href: '/blocks/testimonials' },
  { title: 'Feature Sections', href: '/blocks/feature-sections' },
  { title: 'Pricing Sections', href: '/blocks/pricing-sections' },
  { title: 'Cards', href: '/blocks/cards' },
  { title: 'Navbars', href: '/blocks/navbars' },
  { title: 'Footers', href: '/blocks/footers' },
  { title: 'Login and Signup', href: '/blocks/login-and-signup-sections' },
  { title: 'Contact sections', href: '/blocks/contact-sections' },
  { title: 'Blog Sections', href: '/blocks/blog-sections' },
  { title: 'Blog Content Sections', href: '/blocks/blog-content-sections' },
  { title: 'FAQs', href: '/blocks/faqs' },
  { title: 'Sidebars', href: '/blocks/sidebars' },
  { title: 'Stats Sections', href: '/blocks/stats-sections' },
]
...
const PAGES = [
  ...
  { title: 'Aceternity Studio', href: 'https://www.aceternity.com/' },
  { title: 'Licence', href: '/licence' },
  { title: 'Refunds', href: '/refunds' },
  { title: 'Privacy Policy', href: '/privacy' },
  { title: 'Terms and Conditions', href: '/terms' },
  { title: 'Twitter', href: 'https://x.com/aceternitylabs' },
