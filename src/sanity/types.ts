...
export type FooterNavigation = {
  ...
  newsletterCta?: {
    ...
    contentOrder?: "newsletter-first" | "social-first";
    heading?: string;
    description?: string;
    placeholder?: string;
    buttonLabel?: string;
...
// Query: *[_id == "footerNavigation"][0] {    headline,    headlineFontSizePreset,    subheadline,    primaryCta {      label,      url,      openInNewTab    },    secondaryCta {      label,      url,      openInNewTab    },    columns[] {      _key,      title,      links[] {        _key,        label,        linkType,        url,        externalUrl,        openInNewTab,        badgeImage {          asset-> {            _id,            url,            metadata {              dimensions {                width,                height              }            }          }        }      }    },    newsletterCta {      layout,      contentOrder,      heading,      description,      placeholder,      buttonLabel,      disclaimer    },    showSocialLinks,    showContactInfo,    legalLinks[] {      _key,      label,      linkType,      url,      externalUrl,      openInNewTab    }  }
export type FOOTER_NAVIGATION_QUERY_RESULT =
  ...
  | {
      ...
      newsletterCta: {
        ...
        contentOrder: "newsletter-first" | "social-first" | null;
        heading: string | null;
        description: string | null;
