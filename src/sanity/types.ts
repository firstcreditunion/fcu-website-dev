...
// Query: *[_id == "footerNavigation"][0] {    headline,    headlineFontSizePreset,    subheadline,    primaryCta {      label,      url,      openInNewTab    },    secondaryCta {      label,      url,      openInNewTab    },    columns[] {      _key,      title,      links[] {        _key,        label,        linkType,        url,        externalUrl,        openInNewTab,        badgeImage {          asset-> {            _id,            url,            metadata {              dimensions {                width,                height              }            }          }        }      }    },    newsletterCta {      layout,      heading,      description,      placeholder,      buttonLabel,      disclaimer    },    showSocialLinks,    showContactInfo,    legalLinks[] {      _key,      label,      linkType,      url,      externalUrl,      openInNewTab    }  }
